...
export default function ArregloTable({
  ...
  const [sortConfig, setSortConfig] = useState({ key: "horaEntrega", direction: "asc" });
  ...
  return (
    <>
      ...
      <div className="block md:hidden space-y-3">
          ...
          return (
            ...
            >
              ...
              <div className="text-sm text-gray-600 space-y-0.5">
                <div>{pedido.fecha} {pedido.horaEntrega}</div>
        ...
        {sorted.length === 0 && (
          <p className="text-center text-gray-400 py-8">No hay arreglos pendientes</p>
        )}
      </div>
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-gradient-to-r from-yellow-400 to-amber-500 text-white">
              ...
              <th onClick={() => handleSort("horaEntrega")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[120px]">
                Hora entrega<SortIcon colKey="horaEntrega" />
              </th>
              ...
              <th onClick={() => handleSort("tipoArreglo")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[150px]">
                Tipo arreglo<SortIcon colKey="tipoArreglo" />
              </th>
              <th onClick={() => handleSort("tipoGas")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[80px]">
                Gas<SortIcon colKey="tipoGas" />
              </th>
              <th onClick={() => handleSort("leyenda")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[180px]">
                Leyenda<SortIcon colKey="leyenda" />
              </th>
              <th onClick={() => handleSort("colores")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[150px]">
                Colores<SortIcon colKey="colores" />
              </th>
              <th onClick={() => handleSort("lugar")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[140px]">
                Lugar<SortIcon colKey="lugar" />
              </th>
              ...
              <th onClick={() => handleSort("estado")} className="px-5 py-3.5 text-left font-semibold text-xs uppercase tracking-wider cursor-pointer hover:bg-white/10 transition-colors select-none whitespace-nowrap min-w-[120px]">
          ...
          <tbody className="divide-y divide-gray-200">
            {sorted.map((pedido, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-5 py-3.5 text-gray-700 whitespace-nowrap">{pedido.horaEntrega}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-normal min-w-[220px]">{pedido.descripcion}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-nowrap">{pedido.tipoArreglo || "—"}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-nowrap">{pedido.tipoGas || "—"}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-normal min-w-[180px]">{pedido.leyenda || "—"}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-normal min-w-[150px]">{pedido.colores || "—"}</td>
                  <td className="px-5 py-3.5 text-gray-600 whitespace-nowrap">{pedido.lugar}</td>
                  ...
                  <td className="px-5 py-3.5 whitespace-nowrap">{renderEstado(pedido)}</td>
            ...
            {sorted.length === 0 && (
              <tr>
                <td colSpan={18} className="px-5 py-10 text-center text-gray-400">
